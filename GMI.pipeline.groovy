...
load '/home/ubuntu/GMI_bioinf/variant_calling_pipeline/pipeline_GMI_stages.groovy'

run {
    // Align each pair of input files separately in parallel
    ref_index + "%_L001_R*_001" * [ bwaMEMalign + samToSortedBam + indexBam + dedup + 
    indexBam  + call_variants_freebayes]
}
